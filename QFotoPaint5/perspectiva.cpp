...
//mejoras detectar si el cuadrilatero es concavo y actualizar los arrays de puntos con el tam de la imagen

int corresp[MAX_VENTANAS];
int nfoto1p, nfoto2p; //transformación perspectiva
Point2f ptpers[2][4];
    ...
    ui(new Ui::Perspectiva)
{
    ...
    // si hay solo una abierta, nfoto1p=nfoto2p
    nfoto1p = corresp[0];
    nfoto2p = foto_activa();
